...
function Footer() {
  return (
    <div className="bg-primary text-gray-50 dark:text-gray-300 p-10 flex flex-col items-center">
      <footer className="footer flex lg:flex-row flex-col items-start justify-center gap-x-72">
        <aside className="flex sm:flex-row flex-col sm:gap-x-4 sm:items-center">
          ...
          <div>
            <h2 className="text-3xl font-semibold">Bloggers</h2>
            <p>A platform to share Blogs</p>
          </div>
        </aside>
        <nav>
      ...
      <div className="mt-4 ">
        ...
        <p className="text-center text-neutral dark:text-gray-300">
          &copy; 2025 Bloggers. All rights reserved.
        </p>
      </div>
    </div>
  );
